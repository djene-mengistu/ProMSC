...
class SegmentationEvaluator:
    ...
    def setup_models(self, model1_path, model2_path, use_model1):
        ...
        self.model1 = SEGFORMER('MiT-B0', 6).to(self.device)
...
def main():
    # Configuration
    IMAGE_PATH = "./MTD-SSL/test/test_images/"
    MASK_PATH = "./MTD-SSL/test/test_annot/"
    
    MODEL1_PATH = "./EXP/MTD/MiT-B0_seg_SSL_singlemod_50P_20250829_154230/Checkpoints/MiT-B0_MTD_SSL_50P.pth"
    MODEL2_PATH = "./EXP/MTD/ConvNeXt-T_seg_supervised_singlemod_10P_20250905_150230/Checkpoints/ConvNeXt-T_MTD_supervised_10P.pth"
    ...
    random_indices = random.sample(range(len(test_set)), min(170, len(test_set)))
