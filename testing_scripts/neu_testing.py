...
class SegmentationEvaluator:
    ...
    def setup_models(self, model1_path, model2_path, use_model1):
        ...
        self.model1 = SEGFORMER('MiT-B0', 4).to(self.device)
        self.model2 = CONVNEXTMODEL('ConvNeXt-T', 4).to(self.device)
        ...
        self.model1.load_state_dict(checkpoint_1['state_dict'], strict=False)
...
def main():
    # Configuration
    IMAGE_PATH = "./NEU_VOC/test/test_images/"
    MASK_PATH = "./NEU_VOC/test/test_annot/"
    
    MODEL1_PATH = "./EXP/NEU/MiT-B0_seg_supervised_singlemod_10P_20251006_152358/Checkpoints/MiT-B0_NEU_supervised_10P.pth"
    MODEL2_PATH = "./EXP/NEU/COTRAIN_seg_SSL_singlemod_10P_20250913_212835/Checkpoints/ConvNeXt-T_NEU_SSL_10P.pth"
    ...
    random_indices = random.sample(range(len(test_set)), min(2, len(test_set)))
    ...
    # Print results
    mean_iou = np.mean(results['iou']) * 100
