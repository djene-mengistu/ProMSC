...
def main():
    # Configuration
    IMAGE_PATH = "./TUT_VOC/test/test_images/"
    MASK_PATH = "./TUT_VOC/test/test_annot/"
    
    MODEL1_PATH = "./EXP/TUT/MiT-B0_seg_SSL_singlemod_50P_mIoU_67.33/Checkpoints/MiT-B0_TUT_SSL_50P.pth"
    MODEL2_PATH = "./EXP/TUT/ConvNeXt-T_seg_supervised_singlemod_10P_20250905_150230/Checkpoints/ConvNeXt-T_TUT_supervised_10P.pth"
