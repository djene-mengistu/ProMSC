...
class SegmentationEvaluator:
    ...
    def setup_models(self, model1_path, model2_path, use_model1):
        ...
        self.model1 = SEGFORMER('MiT-B0', 2).to(self.device)
    ...
    @staticmethod
    def mDice(pred_mask, mask, smooth=1e-10, n_classes=2):
        with torch.no_grad():
            pred_mask = F.softmax(pred_mask, dim=1)
...
def main():
    # Configuration
    IMAGE_PATH = "./Crack500_VOC/test/test_images/"
    MASK_PATH = "./Crack500_VOC/test/test_annot/"

    MODEL1_PATH = "./EXP/Crack500/MiT-B0_seg_SSL_singlemod_50P_20251008_232612/Checkpoints/MiT-B0_Crack500_SSL_50P.pth"
    MODEL2_PATH = "./EXP/Crack500/ConvNeXt-T_seg_supervised_singlemod_10P_20250905_150351/Checkpoints/ConvNeXt-T_Crack500_supervised_10P.pth"
    ...
    base_output_dir = "./Output_Crack500"
